        ...
        <>
            ...
            {user && user.length > 0 ?
                ...
                (<>
                    ...
                    <h4 className="right text-black" style={{ marginTop: "8rem", width: "fit-content",marginLeft:"100px"}} ><i>Know more about us!</i></h4>
                    <button onClick={() => getData()} className="right getuser w-25 btn-info text-white" style={{ fontSize: "20px" }} > Get Users</button>
                    {showSpinner ?
